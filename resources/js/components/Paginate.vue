<template>
    <div :id="id">
        ...
        <div class="table-responsive" :style="{ 'margin-top': $props.margin ? '-8rem' : 0 }">
            <table class="table table-rounded table-hover table-striped border gy-7 gs-7"
                :style="{ 'margin': $props.margin ? '8rem 0' : 0 }">
        ...
        <div :class="`d-flex justify-content-between flex-wrap gap-2 ${$props.margin ? 'mt-n20' : ''}`">
