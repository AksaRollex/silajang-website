...
export function block(target, options) {
    ...
    el.append(`
    <div class="blockUI blockOverlay" style="z-index: 10; border: none; margin: 0px; padding: 0px; width: 100%; height: 100%; top: 0px; left: 0px; background-color: rgb(0, 0, 0); opacity: 0.05; cursor: wait; position: absolute;"></div>
    `)
    el.append(`
    <div class="blockUI blockMsg blockElement" style="z-index: 1011; position: absolute; padding: 0px; margin: 0px; width: auto; top: 50%; left: 50%; transform: translateX(-50%); text-align: center; color: rgb(0, 0, 0); border: 0px; cursor: wait;">${spinner}</div>
    `);
}
