  ...
  <div class="w-lg-500px w-100">
    ...
    <main class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework">
      ...
      <div class="mb-10 text-center">
        ...
        <!--begin::Title-->
        <h1 class="text-dark mb-3">Daftar Akun <span class="text-primary">SI-LAJANG</span></h1>
        <!--end::Title-->
      </div>
      <!--end::Heading-->
      ...
      <div class="stepper stepper-links d-flex flex-column" id="kt_create_account_stepper" ref="horizontalWizardRef">
        ...
        <form class="mx-auto mw-600px w-100 pt-15 pb-10" novalidate id="kt_create_account_form" @submit="handleStep">
          ...
          <div data-kt-stepper-element="content">
            <VerifyEmail :formData="formData" @on-complete="handleOtpEmail" @send-otp="sendOtpEmail"></VerifyEmail>
          </div>
          <!--end::Step 2-->

          <!--begin::Step 3-->
          <div data-kt-stepper-element="content">
            <VerifyPhone :formData="formData" @on-complete="handleOtpPhone" @send-otp="sendOtpPhone"></VerifyPhone>
          </div>
          <!--end::Step 3-->
          ...
          <div class="d-flex flex-stack pt-15">
            ...
            <!--begin::Wrapper-->
            <div>
              <button type="submit" id="submit-form" class="btn btn-lg btn-primary me-3" data-kt-stepper-action="submit"
...
interface CreateAccount extends ICredential, IVerifyEmail, IVerifyPhone, IPassword { }
  ...
  setup() {
    ...
    const createAccountSchema = [
      Yup.object({
        ...
        phone: Yup.string().matches(/^08[0-9]\d{8,11}$/, "No. Telepon tidak valid").required("No. Telepon tidak boleh kosong").label("No. Telepon"),
      }),
      Yup.object({}),
      Yup.object({}),
      Yup.object({
        password: Yup.string().min(8, "Password minimal terdiri dari 8 karakter").required("Password tidak boleh kosong").label("Password"),
    ...
    const sendOtpEmail = (callback: any) => {
      ...
      axios.post('/auth/register/get/email/otp', {
    ...
    const checkOtpEmail = (callback: any) => {
      ...
      axios.post('/auth/register/check/email/otp', {
        email: formData.value.email,
    ...
    const sendOtpPhone = (callback: any) => {
      ...
      axios.post('/auth/register/get/phone/otp', {
    ...
    const checkOtpPhone = (callback: any) => {
      ...
      axios.post('/auth/register/check/phone/otp', {
        phone: formData.value.phone,
