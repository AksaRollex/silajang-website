<template>
  <VForm class="card mb-10" @submit="submit" :validation-schema="formSchema">
    ...
    <div class="card-body">
      <div v-if="formData.va_number || formData.qris_value" class="row row-gap-8 mb-20">
          ...
          <div v-else-if="formData.type == 'qris'" :class="`card ${formData.is_expired ? 'opacity-25' : ''}`"
            ...
            <div class="card-body p-4">
              <div class="d-flex bg-light rounded-2 p-4 gap-8 flex-column align-items-center">
                ...
                <button class="btn text-success p-0" :disabled="formData.is_expired" @click="downloadQris()"
                  type="button">
                  Unduh QRIS
                </button>
              </div>
      ...
      <div v-else class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="fv-row mb-7">
            ...
            <Field class="form-control form-control-lg form-control-solid" type="text" name="jumlah" autocomplete="off"
        ...
        <template v-if="formData.type == 'va'">
