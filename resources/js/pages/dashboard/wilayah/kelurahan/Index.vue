<template>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <paginate ref="paginate" id="table-kelurahan" url="/master/kelurahan" :columns="columns"></paginate>
        </div>
    </div>
</template>
...
const column = createColumnHelper<Kelurahan>();
...
export default defineComponent({
    ...
    setup() {
        ...
        const columns = [
            ...
            column.accessor("kecamatan.nama", {
                header: "Kecamatan"
            }),
            column.accessor("kecamatan.kab_kota.nama", {
            ...
            column.accessor("uuid", {
                ...
                cell: (cell) => h('div', { class: 'd-flex gap-2' }, [
                    ...
                    h('button', { class: 'btn btn-sm btn-icon btn-danger', onClick: () => deletePeraturan(`/master/kelurahan/${cell.getValue()}`) }, h('i', { class: 'la la-trash fs-2' }))
