                ...
                <div class="col-md-4">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <select2 placeholder="Pilih Kota/Kabupaten" class="form-select-solid" :options="kabKotas"
                            name="kab_kota_id" v-model="formData.kab_kota_id" @select="formData.kecamatan_id = null">
                        </select2>
                ...
                <div class="col-md-4">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <select2 placeholder="Pilih Kecamatan" class="form-select-solid" :options="kecamatans"
                            name="kecamatan_id" v-model="formData.kecamatan_id">
                        </select2>
                        <div class="fv-plugins-message-container">
                            <div class="fv-help-block">
...
import { useKabKota, useKecamatan } from '@/services';
...
export default defineComponent({
    ...
    setup(props) {
        ...
        const formSchema = Yup.object().shape({
            ...
            kecamatan_id: Yup.string().required('Kecamatan tidak boleh kosong'),
        })
        ...
        const kecamatans = computed(() => kecamatan.data.value?.map(item => ({
            id: item.id,
            text: item.nama
        })))
    ...
    methods: {
        getEdit() {
            ...
            axios.get(`/master/kelurahan/${this.selected}/edit`)
                .then(res => {
        ...
        submit() {
            ...
            axios.post(this.selected ? `/master/kelurahan/${this.selected}/update` : '/master/kelurahan/store', this.formData)
                .then(() => {
                    this.$emit('close')
                    this.$emit('refresh')
