<template>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <paginate ref="paginate" id="table-kecamatan" url="/master/kecamatan" :columns="columns"></paginate>
        </div>
    </div>
</template>
        ...
        const columns = [
            ...
            column.accessor("uuid", {
                ...
                cell: (cell) => h('div', { class: 'd-flex gap-2' }, [
                    ...
                    h('button', { class: 'btn btn-sm btn-icon btn-danger', onClick: () => deletePeraturan(`/master/kecamatan/${cell.getValue()}`) }, h('i', { class: 'la la-trash fs-2' }))
