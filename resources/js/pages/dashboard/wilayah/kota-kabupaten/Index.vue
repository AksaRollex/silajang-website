<template>
    ...
    <div class="card">
        <div class="card-header align-items-center">
            <h2 class="mb-0">Kota/Kabupaten</h2>
        ...
        <div class="card-body">
            <paginate ref="paginate" id="table-kota-kabupaten" url="/master/kota-kabupaten" :columns="columns"></paginate>
        </div>
    </div>
</template>
...
const column = createColumnHelper<KabKota>();
        ...
        const columns = [
            ...
            column.accessor("uuid", {
                ...
                cell: (cell) => h('div', { class: 'd-flex gap-2' }, [
                    ...
                    h('button', { class: 'btn btn-sm btn-icon btn-danger', onClick: () => deletePeraturan(`/master/kota-kabupaten/${cell.getValue()}`) }, h('i', { class: 'la la-trash fs-2' }))
