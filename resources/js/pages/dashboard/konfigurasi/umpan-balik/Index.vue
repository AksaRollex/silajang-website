<template>
  <main>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <paginate ref="paginate" id="table-umpan-balik" url="/konfigurasi/umpan-balik/keterangan" :columns="columns">
        </paginate>
      </div>
    </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="fv-row mb-7">
              ...
              <Field class="form-control form-control-lg form-control-solid" type="text" name="kode" autocomplete="off"
                v-model="formData.kode" disabled />
