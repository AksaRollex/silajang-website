<template>
  <main v-if="user?.role.name === 'customer'">
      ...
      <div class="card-body mt-n20">
        ...
        <div class="mt-n20 position-relative">
          ...
          <div class="row g-3 g-lg-6">
            ...
            <div class="col-sm-6">
              <!--begin::Items-->
              <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5 border-warning border-left-5 border-start">
                <!--begin::Symbol-->
                <div class="symbol symbol-30px me-5 mb-8">
                  <span class="symbol-label">
    ...
    data.permohonanDiproses
      ...
      data.permohonanSelesai
            ...
            <div class="col-sm-6">
              <!--begin::Items-->
              <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5 border-primary border-left-5 border-start">
                <!--begin::Symbol-->
                <div class="symbol symbol-30px me-5 mb-8">
                  <span class="symbol-label">
  ...
  <main v-else>
      ...
      <div class="card-body mt-n20">
        ...
        <div class="mt-n20 position-relative">
          ...
          <div class="row g-3 g-lg-6">
            ...
            <!--end::Col-->
            <!--begin::Col-->
            <div v-if="['admin', 'kepala-upt', 'koordinator-administrasi'].includes(user.role.name)" class="col-sm-6">
              <!--begin::Items-->
              <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5 border-primary border-left-5 border-start">
                <!--begin::Symbol-->
                <div class="symbol symbol-30px me-5 mb-8">
    ...
    data.unverifSampels
            ...
            <!--begin::Col-->
            <div
              v-if="['admin', 'kepala-upt', 'koordinator-teknis', 'koordinator-administrasi'].includes(user.role.name)"
              class="col-sm-6">
              <!--begin::Items-->
