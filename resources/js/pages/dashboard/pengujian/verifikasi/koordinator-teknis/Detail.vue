<template>
  <div class="card mb-10">
    ...
    <div class="card-body pb-10">
      <div v-if="Boolean(formData.keterangan_revisi)" class="card bg-light border-warning border-0 rounded-2 mb-8"
        style="border-left-width: 5px !important; border-left-style: solid !important;">
        <div class="card-body">
          <h6>Revisi:</h6>
          {{ formData.keterangan_revisi }}
        </div>
      </div>
      ...
      <div class="fv-row mb-10">
        ...
        <div class="d-flex align-items-center gap-4">
          <div class="form-check form-check-custom form-check-solid">
            <input class="form-check-input" type="radio" value="1" name="memenuhi_hasil_pengujian" id="interpretasi-1"
              v-model="formData.memenuhi_hasil_pengujian" @change="change()" />
            <label class="form-check-label" for="interpretasi-1">
              Memenuhi Persyaratan
            </label>
          </div>
          <div class="form-check form-check-custom form-check-solid">
            <input class="form-check-input" type="radio" value="0" name="memenuhi_hasil_pengujian" id="interpretasi-2"
              v-model="formData.memenuhi_hasil_pengujian" @change="change()" />
                ...
                <div class="row row-gap-6">
                  <div class="col-6">
                    ...
                    <Field class="form-control form-control-lg form-control-solid" type="text"
                      :disabled="formData.status < 5" autocomplete="off" v-model="param.pivot.satuan" required
                      placeholder="Satuan" />
                  </div>
                  <div class="col-6">
                    ...
                    <Field v-if="formData.baku_mutu" class="form-control form-control-lg form-control-solid" type="text"
                      :disabled="formData.status < 5" autocomplete="off" v-model="param.pivot.baku_mutu" required
                      placeholder="Baku Mutu" />
                    <Field v-else class="form-control form-control-lg form-control-solid" type="text" value="-"
                      readonly />
                  </div>
                  <div class="col-6">
                    <div class="text-muted mb-2">MDL</div>
                    <Field class="form-control form-control-lg form-control-solid" type="text"
                      :disabled="formData.status < 5" autocomplete="off" v-model="param.pivot.mdl" placeholder="MDL" />
                  </div>
                  <div class="row">
                    <div class="col-6">
                      <div class="text-muted mb-2 required">Hasil Uji <strong class="fs-8">(Analis)</strong></div>
                      <Field class="form-control form-control-lg form-control-solid" type="text"
                        :disabled="formData.status < 5" autocomplete="off" v-model="param.pivot.hasil_uji" required
                        placeholder="Hasil Uji" />
                    </div>
                    <div class="col-6">
                      <div class="text-muted mb-2 required">Hasil Uji <strong class="fs-8">(Pembulatan)</strong></div>
                      <Field class="form-control form-control-lg form-control-solid" type="text"
                        :disabled="formData.status < 5" autocomplete="off" v-model="param.pivot.hasil_uji_pembulatan"
                        required placeholder="Hasil Uji" />
                    </div>
                  </div>
                  <div class="col-12">
