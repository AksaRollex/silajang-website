...
export default defineComponent({
    ...
    methods: {
        submit() {
            ...
            block(this.$el)
            axios.post(`/verifikasi/koordinator-teknis/revisi/${this.selected}`, data)
                .then(() => {
...
<template>
    <VForm class="card mb-10" @submit="submit" :validation-schema="formSchema" id="form-revisi">
        <div class="card-header align-items-center">
            ...
            <button type="button" class="btn btn-sm btn-light-danger ms-auto" @click="$emit('close')"><i class="la la-times-circle fs-2"></i> Batal</button>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <!-- begin::input-group -->
                     <div class="fv-row mb-7">
                        ...
                        <Field class="form-control form-control-lg form-control-solid" type="text" name="revisi" autocomplete="off" v-model="formData.revisi">
                            <textarea name="revisi" autocomplete="off" rows="3" class="form-control form-control-lg form-control-solid"
                            v-model="formData.revisi"></textarea>
                        </Field>
