    ...
    <div class="card-body">
      <div class="d-flex gap-10 mb-10">
        ...
        <div class="form-group">
          ...
          <select2 class="form-select-solid mw-200px mw-md-100" name="tahun" :options="golongans" v-model="golonganId">
          </select2>
        </div>
      </div>
      ...
      <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x mb-5 fs-6">
        ...
        <li class="nav-item">
          <a class="nav-link btn btn-active-light rounded-bottom-0" data-bs-toggle="tab" href="#tab-total-biaya">Total
            Biaya</a>
        </li>
        <!-- <li class="nav-item">
      ...
      <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="tab-sampel-permohonan" role="tabpanel">
          ...
          <paginate ref="paginate" id="table-sampel-permohonan" url="/report/rekap" :columns="columnsSampelPermohonan"
            queryKey="sampel-permohonan" :payload="{ start, end, is_mandiri: isMandiri, golongan_id: golonganId }">
          </paginate>
        </div>
