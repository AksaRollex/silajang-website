                                        ...
                                        <div class="d-flex align-items-center gap-4">
                                            <div class="form-check form-check-custom form-check-solid">
                                                <input class="form-check-input" type="radio" value="0"
                                                    name="kesimpulan_permohonan" id="status-menunggu"
                                                    v-model="formData.kesimpulan_permohonan" @change="change()" />
                                            ...
                                            <div class="form-check form-check-custom form-check-solid">
                                                <input class="form-check-input" type="radio" value="1"
                                                    name="kesimpulan_permohonan" id="status-diterima"
                                                    v-model="formData.kesimpulan_permohonan" @change="change()" />
                                            ...
                                            <div class="form-check form-check-custom form-check-solid">
                                                <input class="form-check-input" type="radio" value="2"
                                                    name="kesimpulan_permohonan" id="status-ditolak"
                                                    v-model="formData.kesimpulan_permohonan" @change="change()" />
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="d-flex align-items-center mb-7">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="fv-row">
                                        <Field v-model="formData.permohonan.radius_pengambilan_id"
                                            name="radius_pengambilan_id">
                                            <select2 placeholder="Pilih Radius Pengambilan"
                                                class="form-select-solid mw-200px mw-md-100" name="radius_pengambilan_id"
                                                @select="change()" :options="radiuses"
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="fv-row">
                                        <Field v-model="formData.petugas_pengambil_ids" name="petugas_pengambil_ids">
                                            <select2 placeholder="Pilih Petugas Pengambil"
                                                class="form-select-solid mw-200px mw-md-100" name="petugas_pengambil_ids"
                                                @select="change()" :options="petugases"
                                                v-model="formData.petugas_pengambil_ids"
                                                :disabled="user.role?.name === 'pengambil-sample'"
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="fv-row">
                                        <Field v-model="formData.tanggal_pengambilan" name="tanggal_pengambilan">
                                            <date-picker v-model="formData.tanggal_pengambilan" name="tanggal_pengambilan"
                                    ...
                                    <div class="fv-row">
                                        <Field v-model="formData.acuan_metode_id" name="acuan_metode_id">
                                            <select2 placeholder="Pilih Metode" @select="change()"
                                                class="form-select-solid mw-200px mw-md-100" name="acuan_metode_id"
                            ...
                            <div class="d-flex align-items-center mb-7">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="fv-row">
                                        <Field class="form-control form-control-lg form-control-solid" type="text"
                                            @change="change()" name="obyek_pelayanan" autocomplete="off"
                                            v-model="formData.obyek_pelayanan" />
                                        <div class="fv-plugins-message-container">
                                            <div class="fv-help-block">
