    ...
    <div class="card mb-10">
        ...
        <div class="card-body">
            <paginate ref="paginateKonfirmasi" id="table-konfirmasi" url="/administrasi/pengambil-sample"
                :columns="columnsBelum" queryKey="pengambil-sample-0" :payload="{ status: 0, tahun: tahunKonfirmasi }">
            </paginate>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <paginate ref="paginateDiambil" id="table-diambil" url="/administrasi/pengambil-sample" :columns="columnsSudah"
                queryKey="pengambil-sample-1" :payload="{ status: 1, tahun: tahunSelesai }">
            </paginate>
        </div>
    </div>
