                ...
                <div class="col-md-6">
                  <div class="d-flex align-items-center mb-7">
                    ...
                    <div class="d-flex flex-column">
                      ...
                      <div class="text-dark text-hover-primary fs-6 fw-bold" style="cursor: pointer;"
                  ...
                  <div class="fv-row mb-10">
                    ...
                    <div class="d-flex align-items-center gap-4">
                      <div class="form-check form-check-custom form-check-solid">
                        <input class="form-check-input" type="radio" value="0" name="kesimpulan_kontrak"
                          id="status-menunggu" v-model="formData.kesimpulan_kontrak" @change="change()" />
                        <label class="form-check-label" for="status-menunggu">
                          Menunggu
                        </label>
                      </div>
                      <div class="form-check form-check-custom form-check-solid">
                        <input class="form-check-input" type="radio" value="1" name="kesimpulan_kontrak"
                          id="status-diterima" v-model="formData.kesimpulan_kontrak" @change="change()" />
                        <label class="form-check-label" for="status-diterima">
                          Diterima
                        </label>
                      </div>
                      <div class="form-check form-check-custom form-check-solid">
                        <input class="form-check-input" type="radio" value="2" name="kesimpulan_kontrak"
                          id="status-ditolak" v-model="formData.kesimpulan_kontrak" @change="change()" />
