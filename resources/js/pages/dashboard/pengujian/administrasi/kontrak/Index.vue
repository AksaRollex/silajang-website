<template>
  ...
  <div class="card mb-10">
    ...
    <div class="card-body">
      <paginate ref="paginateMenunggu" id="table-menunggu" url="/administrasi/kontrak" :columns="columnsMenunggu"
        queryKey="kontrak-0" :payload="{ kesimpulan_kontrak: 0, tahun: tahunMenunggu }">
      </paginate>
    </div>
  </div>
  ...
  <div class="card mb-10">
    ...
    <div class="card-body">
      <paginate ref="paginateDiterima" id="table-diterima" url="/administrasi/kontrak" :columns="columnsDiterima"
        queryKey="kontrak-1" :payload="{ kesimpulan_kontrak: 1, tahun: tahunDiterima }">
      </paginate>
    </div>
  </div>
  ...
  <div class="card mb-10">
    ...
    <div class="card-body">
      <paginate ref="paginateDiterima" id="table-ditolak" url="/administrasi/kontrak" :columns="columnsDitolak"
        queryKey="kontrak-2" :payload="{ kesimpulan_kontrak: 2, tahun: tahunDitolak }">
      </paginate>
    </div>
  </div>
