                ...
                <div class="col-md-12">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <Field class="form-control form-control-lg form-control-solid" type="text" name="lokasi"
                            autocomplete="off" v-model="formData.lokasi" />
                ...
                <div class="col-md-4">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <Field v-model="formData.jenis_wadahs_id" name="jenis_wadahs_id">
                            <select2 placeholder="Pilih Jenis Wadah" class="form-select-solid" name="jenis_wadahs_id"
                                multiple :settings="{ allowClear: true, multiple: true }" :options="jenisWadahs"
                ...
                <template v-if="$props.permohonan.is_mandiri">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <Field class="form-control form-control-lg form-control-solid" type="text" name="south"
                                autocomplete="off" v-model="formData.south" />
                            <div class="fv-plugins-message-container">
                                <div class="fv-help-block">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <Field class="form-control form-control-lg form-control-solid" type="text" name="east"
                                autocomplete="off" v-model="formData.east" />
                            <div class="fv-plugins-message-container">
                                <div class="fv-help-block">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <Field class="form-control form-control-lg form-control-solid" type="text" name="ph"
                                autocomplete="off" v-model="formData.lapangan.ph" />
                            <div class="fv-plugins-message-container">
                                <div class="fv-help-block">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <Field class="form-control form-control-lg form-control-solid" type="text" name="dhl"
                                autocomplete="off" v-model="formData.lapangan.dhl" />
                            <div class="fv-plugins-message-container">
                                <div class="fv-help-block">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <Field class="form-control form-control-lg form-control-solid" type="text" name="do"
                                autocomplete="off" v-model="formData.lapangan.do" />
                            <div class="fv-plugins-message-container">
                                <div class="fv-help-block">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <Field class="form-control form-control-lg form-control-solid" type="text" name="cuaca"
                                autocomplete="off" v-model="formData.lapangan.cuaca" />
                            <div class="fv-plugins-message-container">
                                <div class="fv-help-block">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <Field class="form-control form-control-lg form-control-solid" type="text"
                                name="kecepatan_angin" autocomplete="off" v-model="formData.lapangan.kecepatan_angin" />
                            <div class="fv-plugins-message-container">
                                <div class="fv-help-block">
