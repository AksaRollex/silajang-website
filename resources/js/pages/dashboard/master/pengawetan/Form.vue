<template>
    <VForm class="card mb-10" @submit="submit" :validation-schema="formSchema">
        <div class="card-header align-items-center">
            <h2 class="mb-0">{{ selected ? 'Edit' : 'Tambah' }} Pengawetan</h2>
...
export default defineComponent({
    ...
    methods: {
        getEdit() {
            ...
            axios.get(`/master/pengawetan/${this.selected}/edit`)
                .then(res => {
        ...
        submit() {
            ...
            axios.post(this.selected ? `/master/pengawetan/${this.selected}/update` : '/master/pengawetan/store', this.formData)
                .then(() => {
                    this.$emit('close')
                    this.$emit('refresh')
