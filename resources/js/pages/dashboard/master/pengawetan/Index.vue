<template>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <paginate ref="paginate" id="table-pengawetan" url="/master/pengawetan" :columns="columns"></paginate>
        </div>
    </div>
</template>
...
interface Pengawetan {
    no: number,
    uuid: string,
    nama: string,
}
import { createColumnHelper } from "@tanstack/vue-table";
const column = createColumnHelper<Pengawetan>();
