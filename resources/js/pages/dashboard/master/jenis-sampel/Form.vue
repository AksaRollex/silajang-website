<template>
    <VForm class="card mb-10" @submit="submit" :validation-schema="formSchema">
        <div class="card-header align-items-center">
            <h2 class="mb-0">{{ selected ? 'Edit' : 'Tambah' }} Jenis Sampel</h2>
...
export default defineComponent({
    ...
    methods: {
        getEdit() {
            ...
            axios.get(`/master/jenis-sampel/${this.selected}/edit`)
                .then(res => {
        ...
        submit() {
            ...
            axios.post(this.selected ? `/master/jenis-sampel/${this.selected}/update` : '/master/jenis-sampel/store', this.formData)
                .then(() => {
                    this.$emit('close')
                    this.$emit('refresh')
