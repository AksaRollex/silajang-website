<template>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <paginate ref="paginate" id="table-jenis-sampel" url="/master/jenis-sampel" :columns="columns"></paginate>
        </div>
    </div>
</template>
        ...
        const columns = [
            ...
            column.accessor("uuid", {
                ...
                cell: (cell) => h('div', { class: 'd-flex gap-2' }, [
                    ...
                    h('button', { class: 'btn btn-sm btn-icon btn-danger', onClick: () => deleteJenis(`/master/jenis-sampel/${cell.getValue()}`) }, h('i', { class: 'la la-trash fs-2' }))
