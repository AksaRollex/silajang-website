<template>
    <VForm class="card mb-10" @submit="submit" :validation-schema="formSchema">
        <div class="card-header align-items-center">
            <h2 class="mb-0">{{ selected ? 'Edit' : 'Tambah' }} Kode Retribusi</h2>
                ...
                <div class="col-md-2">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <Field class="form-control form-control-lg form-control-solid" type="text" name="kode"
                            autocomplete="off" v-model="formData.kode" />
...
export default defineComponent({
    ...
    methods: {
        getEdit() {
            ...
            axios.get(`/master/kode-retribusi/${this.selected}/edit`)
                .then(res => {
        ...
        submit() {
            ...
            axios.post(this.selected ? `/master/kode-retribusi/${this.selected}/update` : '/master/kode-retribusi/store', this.formData)
                .then(() => {
                    this.$emit('close')
                    this.$emit('refresh')
