...
{
    use Uuid;
    protected $fillable = ['kode', 'va_number', 'nama', 'jumlah', 'tanggal_exp', 'is_lunas', 'status', 'tanggal_bayar', 'titik_permohonan_id', 'kode_retribusi_id', 'berita1', 'berita2', 'berita3', 'berita4', 'berita5'];
